...
export const notifications = [
  ...
  { id: "n6", type: "แมลง", title: "พบการระบาดของเพลี้ยไฟในรัศมี 5 กม. จากสวน", time: "25 นาทีที่แล้ว", level: "กลาง" },
...
export const areaBiosecurityAlerts = [
  {
    id: "a1",
    type: "โรค",
    title: "เสี่ยงโรครากเน่าโคนเน่า",
    area: "ต.บางกะปิ · รัศมี 5 กม.",
    risk: 82,
    crops: "ทุเรียน, มังคุด",
    reason: "มีรายงานพบโรคในพื้นที่ใกล้เคียง และความชื้นสะสมสูงหลังฝนตก",
    action: "ตรวจโคนต้นและระบายน้ำรอบแปลงภายในวันนี้",
    updated: "อัปเดต 10 นาทีที่แล้ว",
  },
  {
    id: "a2",
    type: "แมลง",
    title: "เฝ้าระวังเพลี้ยไฟ",
    area: "ต.บางกะปิ · รัศมี 3 กม.",
    risk: 58,
    crops: "ทุเรียน, ลำไย",
    reason: "กับดักแมลงในพื้นที่รายงานจำนวนเพลี้ยไฟเพิ่มขึ้นต่อเนื่อง",
    action: "สุ่มตรวจยอดอ่อนและใต้ใบช่วงเช้า",
    updated: "อัปเดต 25 นาทีที่แล้ว",
  },
];
